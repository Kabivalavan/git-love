...
import { TrendingUp, ShoppingBag, ChevronLeft, ChevronRight, ShoppingCart, Minus, Plus } from 'lucide-react';
...
function RecommendationCard({ product: p, onTrack }: { product: Product; onTrack: () => void }) {
  ...
  return (
    <div className="flex-shrink-0 w-[160px] md:w-[200px] snap-start" onClick={onTrack}>
      <Link to={`/product/${p.slug}`} className="block bg-card rounded-2xl border border-border overflow-hidden group">
        ...
        <div className="p-2.5">
          ...
          <div className="flex items-center justify-between mt-2">
            ...
            <Button size="sm" className="h-7 px-2.5 text-xs rounded-lg gap-1">
